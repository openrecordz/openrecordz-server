...
<div class="error">
	<div class="error-notify">
	   <!--  <div class="img"><img alt="" src="http://cf2.fancyimgs.com/images/common/error-404.png"></div> -->
		<h2>Hoops!</h2>
		<p><s:message code="errorpage.500"/>
		<small><a href="javascript:history.go(-1)">Go back</a> or <a href="mailto:info@ciaotrip.it">let us know</a> if this problem persists. </small></p>
