...
//                    break;
                 ...
                 case 'A':
                     pc = new UserAgentPatternConverter(formattingInfo, extractPrecisionOption());
                     break;
...
//              return carbonContext.getTenantDomain();
          ...
          public String getCurrentTenantName() {
        	  try {
	      		Tenant t= TenantThreadLocal.get();
	      		if (t!=null)
...
//                return carbonContext.getUsername();
            	return getCurrentLoggedUsername();
            }
        ...
        private static class UserAgentPatternConverter extends TenantAwareNamedPatternConverter {
//          CarbonContext carbonContext;

          public UserAgentPatternConverter(FormattingInfo formattingInfo, int precision) {
              super(formattingInfo, precision);
//              carbonContext = carbonContext1;
          }
...
//        	  http://wurfl.sourceforge.net/docs/java/net/sourceforge/wurfl/core/utils/UserAgentUtils.html
//        	  http://www.bitwalker.eu/software/user-agent-utils
//        	  https://github.com/HaraldWalker/user-agent-utils
          	try {
          		if (RequestThreadLocal.get().get(RequestThreadLocal.REQUEST_INFO_TREADEDLOCAL_USER_AGENT)!=null)
          			return RequestThreadLocal.get().get(RequestThreadLocal.REQUEST_INFO_TREADEDLOCAL_USER_AGENT).toString();
          		else
          			return "sys";
