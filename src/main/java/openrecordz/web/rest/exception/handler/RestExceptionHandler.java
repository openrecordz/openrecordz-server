 ...
 */
package openrecordz.web.rest.exception.handler;
 ...
 *     {@link openrecordz.web.rest.exception.handler.RestError#getStatus() status} value.</li>
...
//        this.setWarnLogCategory(logger);
    ...
    public String getRequestUriRegEx() {
		return requestUriRegEx;
	}

	public void setRequestUriRegEx(String requestUriRegEx) {
		this.requestUriRegEx = requestUriRegEx;
	}
	...
	protected boolean shouldApplyTo(HttpServletRequest request, Object handler) {
		boolean shouldApply =  super.shouldApplyTo(request, handler);
		if (request.getRequestURI().matches(requestUriRegEx))
			return shouldApply;
		else 
			return false;
	}
